...
\node [decision,text width=3cm,below=1cm of start] (buff) {{\Large Inertia Shape Integrals}}; 
...
\ganttbar[progress=0, name=T1A]{\scriptsize{Adquisición parámetros dinámicos}}{2016-06}{2016-07} \\
\ganttbar[progress=0, name=T1A]{{\scriptsize Modelo Biomecánico rígido}}{2016-07}{2016-09} \\
...
\tiny{\bibliography{Proposal,patents}}
\end{frame}
